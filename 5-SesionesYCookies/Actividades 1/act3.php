...
<body>
    ...
    $contraseña = !empty($_POST['pasword']) ? $_POST['pasword']  : null;
    if ($usuario != null && $contraseña != null) {
        if ($usuario == 'alumno' && $contraseña == 'alumno') {
        ...
        <div class="container">
            <div class="abs-center">
                <form method="post" action="#" class="border p-3 form">
                    <div class="container">
                        <div class="form-group row">
                            <label for="Ecuacion">Usuario</label>
                            <input type="text" class="form-control col" min="0" step="0.01" name="num">
                            <label for="Ecuacion">Paswword</label>
                            <input type="password" class="form-control col" min="0" step="0.01" name="num">
                        </div>
                    </div>
                    <br>
                    <div class=" row ">
                        <button type="submit" name="iniciar" class="btn btn-primary col">Iniciar sesion</button>
                    </div>
